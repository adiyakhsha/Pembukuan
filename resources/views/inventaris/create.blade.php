...
@section('content')
    ...
    <form action="{{ route('inventaris.store') }}" method="POST">
        ...
        <div class="form-group">
                ...
                <input type="text" id="jumlah_inventaris" name="jumlah_inventaris" class="form-control">
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                ...
                <input type="text" id="ket_inventaris" name="ket_inventaris" class="form-control">
        </div>
